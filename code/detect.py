...
def run():
    ...
    parser.add_argument("-w", "--weight_path", type=str, default="/Users/weimingan/work/weights/yolov3_voc_sgd_500.pth",
                        help="权重文件")
    ...
    parser.add_argument("--nms_thres", type=float, default=0.45, help="NMS阈值")
