...
# 读取本地的标签文件转换为自己的标签格式
def convert_coco_annotation(label_files, target_paths):
    for i, label_file in enumerate(label_files):
        ...
        with open(label_file, "r") as f:
            ...
            for annotation in annotations:
                ...
                # 根据类别名称，从类别文件中获取下标
                cidx = args['classes_names'].index(category_name)
        ...
        # 写入文件
        target = os.path.join(project_path, target_paths[i])
...
if __name__ == '__main__':
    ...
    #==========================================coco===========
    data_path = 'data/coco2017.yaml'
    args = parse_yaml(os.path.join(project_path, data_path))
    convert_coco_annotation(args['segments'], args['targets'])
